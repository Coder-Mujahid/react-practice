    ...
    <div className="w-full h-screen flex items-center justify-center">
      ...
      <div
        ...
        >
          ...
          {/* Clock hands */}
          <div className="hour-hand absolute shadow-xl shadow-black bg-sky-400 z-10 w-3 h-20 rounded-lg top-[72px] left-1/2 transform -translate-x-1/2 -translate-y-1/2 origin-bottom" style={{ transform: `rotate(${hoursAngle}deg)` }}></div>
          <div className="minute-hand absolute shadow-xl shadow-black bg-green-500 z-10 w-2 h-28 rounded-lg top-[38px] left-1/2 transform -translate-x-1/2 -translate-y-1/2 origin-bottom" style={{ transform: `rotate(${minutesAngle}deg)` }}></div>
          <div className="second-hand absolute shadow-xl shadow-black bg-red-500 z-10 w-1 h-32 origin-bottom top-[24px] left-1/2 transform -translate-x-1/2 -translate-y-1/2" style={{ transform: `rotate(${secondsAngle}deg)` }}></div>
          {/* Center circle */}
          <div className="center-circle absolute z-20 bg-black w-6 h-6 rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
        </div>
      </div>
    </div>
  );
